...
import type toolCalling from '../agent/tool-calling/index.js';
 ...
 */
export type POSTApiChatInput = InferInput<typeof toolCalling['inputSchema']>;

/**
 * Output type for route: POST /api/chat
 */
export type POSTApiChatOutput = InferOutput<typeof toolCalling['outputSchema']>;

/**
 * Input schema type for route: POST /api/chat
 */
export type POSTApiChatInputSchema = typeof toolCalling extends { inputSchema?: infer I } ? I : never;

/**
 * Output schema type for route: POST /api/chat
 */
export type POSTApiChatOutputSchema = typeof toolCalling extends { outputSchema?: infer O } ? O : never;
...
declare module '@agentuity/frontend' {
	...
	'POST /api/chat': {
				...
				stream: typeof toolCalling extends { stream?: infer S } ? S : false;
				params: never;
			};
	}
