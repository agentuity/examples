...
import type handoffs from '../agent/handoffs/index.js';
 ...
 */
export type POSTApiChatInput = InferInput<typeof handoffs['inputSchema']>;

/**
 * Output type for route: POST /api/chat
 */
export type POSTApiChatOutput = InferOutput<typeof handoffs['outputSchema']>;

/**
 * Input schema type for route: POST /api/chat
 */
export type POSTApiChatInputSchema = typeof handoffs extends { inputSchema?: infer I } ? I : never;

/**
 * Output schema type for route: POST /api/chat
 */
export type POSTApiChatOutputSchema = typeof handoffs extends { outputSchema?: infer O } ? O : never;
...
declare module '@agentuity/frontend' {
	...
	'POST /api/chat': {
				...
				stream: typeof handoffs extends { stream?: infer S } ? S : false;
				params: never;
			};
	}
