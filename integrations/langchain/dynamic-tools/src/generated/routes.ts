...
import type dynamicTools from '../agent/dynamic-tools/index.js';
 ...
 */
export type POSTApiChatInput = InferInput<typeof dynamicTools['inputSchema']>;

/**
 * Output type for route: POST /api/chat
 */
export type POSTApiChatOutput = InferOutput<typeof dynamicTools['outputSchema']>;

/**
 * Input schema type for route: POST /api/chat
 */
export type POSTApiChatInputSchema = typeof dynamicTools extends { inputSchema?: infer I } ? I : never;

/**
 * Output schema type for route: POST /api/chat
 */
export type POSTApiChatOutputSchema = typeof dynamicTools extends { outputSchema?: infer O } ? O : never;
...
declare module '@agentuity/frontend' {
	...
	'POST /api/chat': {
				...
				stream: typeof dynamicTools extends { stream?: infer S } ? S : false;
				params: never;
			};
	}
