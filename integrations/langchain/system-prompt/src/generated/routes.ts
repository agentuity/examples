...
import type systemPrompt from '../agent/system-prompt/index.js';
 ...
 */
export type POSTApiChatInput = InferInput<typeof systemPrompt['inputSchema']>;

/**
 * Output type for route: POST /api/chat
 */
export type POSTApiChatOutput = InferOutput<typeof systemPrompt['outputSchema']>;

/**
 * Input schema type for route: POST /api/chat
 */
export type POSTApiChatInputSchema = typeof systemPrompt extends { inputSchema?: infer I } ? I : never;

/**
 * Output schema type for route: POST /api/chat
 */
export type POSTApiChatOutputSchema = typeof systemPrompt extends { outputSchema?: infer O } ? O : never;
...
declare module '@agentuity/frontend' {
	...
	'POST /api/chat': {
				...
				stream: typeof systemPrompt extends { stream?: infer S } ? S : false;
				params: never;
			};
	}
