...
import type dynamicModel from '../agent/dynamic-model/index.js';
 ...
 */
export type POSTApiChatInput = InferInput<typeof dynamicModel['inputSchema']>;

/**
 * Output type for route: POST /api/chat
 */
export type POSTApiChatOutput = InferOutput<typeof dynamicModel['outputSchema']>;

/**
 * Input schema type for route: POST /api/chat
 */
export type POSTApiChatInputSchema = typeof dynamicModel extends { inputSchema?: infer I } ? I : never;

/**
 * Output schema type for route: POST /api/chat
 */
export type POSTApiChatOutputSchema = typeof dynamicModel extends { outputSchema?: infer O } ? O : never;
...
declare module '@agentuity/frontend' {
	...
	'POST /api/chat': {
				...
				stream: typeof dynamicModel extends { stream?: infer S } ? S : false;
				params: never;
			};
	}
