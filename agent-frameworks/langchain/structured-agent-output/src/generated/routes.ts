...
import type structuredOutput from '../agent/structured-output/index.js';
 ...
 */
export type POSTApiChatInput = InferInput<typeof structuredOutput['inputSchema']>;

/**
 * Output type for route: POST /api/chat
 */
export type POSTApiChatOutput = InferOutput<typeof structuredOutput['outputSchema']>;

/**
 * Input schema type for route: POST /api/chat
 */
export type POSTApiChatInputSchema = typeof structuredOutput extends { inputSchema?: infer I } ? I : never;

/**
 * Output schema type for route: POST /api/chat
 */
export type POSTApiChatOutputSchema = typeof structuredOutput extends { outputSchema?: infer O } ? O : never;
...
declare module '@agentuity/frontend' {
	...
	'POST /api/chat': {
				...
				stream: typeof structuredOutput extends { stream?: infer S } ? S : false;
				params: never;
			};
	}
