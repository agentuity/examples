...
import type adkTime from '../agent/adk-time/index.js';
...
/**
 * Input type for route: POST /api/adk-time
 */
export type POSTApiAdkTimeInput = InferInput<typeof adkTime['inputSchema']>;

/**
 * Output type for route: POST /api/adk-time
 */
export type POSTApiAdkTimeOutput = InferOutput<typeof adkTime['outputSchema']>;

/**
 * Input schema type for route: POST /api/adk-time
 */
export type POSTApiAdkTimeInputSchema = typeof adkTime extends { inputSchema?: infer I } ? I : never;

/**
 * Output schema type for route: POST /api/adk-time
 */
export type POSTApiAdkTimeOutputSchema = typeof adkTime extends { outputSchema?: infer O } ? O : never;
...
declare module '@agentuity/frontend' {
	...
	'POST /api/adk-time': {
				inputSchema: POSTApiAdkTimeInputSchema;
				outputSchema: POSTApiAdkTimeOutputSchema;
				stream: typeof adkTime extends { stream?: infer S } ? S : false;
				params: never;
			};
	'POST /api/translate': {
	...
	export interface RPCRouteRegistry {
		adkTime: {
			/**
			 * Route: POST /api/adk-time
			 */
			post: { input: POSTApiAdkTimeInput; output: POSTApiAdkTimeOutput; type: 'api'; params: never; paramsTuple: [] };
		};
		translate: {
			history: {
				/**
