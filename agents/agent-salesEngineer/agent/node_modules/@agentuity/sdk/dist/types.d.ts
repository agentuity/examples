 ...
 */
export type TriggerType = 'webhook' | 'cron' | 'manual' | 'agent' | 'sms' | 'queue' | 'voice' | 'email' | 'agent';
/**
 ...
 */
export declare function isDataObject(value: unknown): value is Data;
export type ReadableDataType = Buffer | Uint8Array | ArrayBuffer | string | Blob;
/**
 * The type of data that can be passed to an agent as a payload
 */
export type DataType = Buffer | Uint8Array | ArrayBuffer | string | Json | Blob | ReadableStream | Data;
/**
 ...
 */
export type JsonPrimitive = string | number | boolean | null | JsonArray | JsonObject;
/**
 * JSON array type
 */
...
export type VectorUpsertParams = VectorUpsertBase & (VectorUpsertEmbeddings | VectorUpsertText);
...
export interface EmailService {
     ...
     */
    sendReply(agentId: string, email: string, authToken: string, messageId: string): Promise<void>;
}
...
export type GetAgentRequestParams = GetAgentRequestParamsById | GetAgentRequestParamsByName;
...
export interface AgentResponse {
     ...
     * @returns the response from the agent
     */
    handoff<M = unknown>(agent: GetAgentRequestParams, args?: InvocationArguments<M>): Promise<AgentRedirectResponse>;
    /**
 ...
 */
export type AgentHandler = (request: AgentRequest, response: AgentResponse, context: AgentContext) => Promise<AgentResponseData | Response>;
 ...
 */
export type AgentWelcome = () => AgentWelcomeResult | Promise<AgentWelcomeResult>;
/**
