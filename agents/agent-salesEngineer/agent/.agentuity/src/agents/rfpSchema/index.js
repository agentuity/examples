...
// src/agents/rfpSimple.js
var rfpSimple = `# Request for Proposal (RFP)
...
// src/agents/rfpSchema/index.ts
var EXTRACTION_PROMPT = `You are an assistant that extracts fields from a form or document to create a JSON schema.
...
var welcome = () => {
  return {
    welcome: "Welcome to the RFP Schema Agent! I can help you generate a JSON Schema for a provided RFP document.",
    prompts: [
      {
        data: rfpSimple,
