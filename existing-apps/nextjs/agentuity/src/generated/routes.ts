...
import type translateAgent from '../agent/translate/agent.js';
import type { TranslateHistoryStateSchema as TranslateHistoryStateSchema_0 } from '../agent/translate/state';
 ...
 */
export type POSTApiTranslateInput = InferInput<typeof translateAgent['inputSchema']>;

/**
 * Output type for route: POST /api/translate
 */
export type POSTApiTranslateOutput = InferOutput<typeof translateAgent['outputSchema']>;

/**
 * Input schema type for route: POST /api/translate
 */
export type POSTApiTranslateInputSchema = typeof translateAgent extends { inputSchema?: infer I } ? I : never;

/**
 * Output schema type for route: POST /api/translate
 */
export type POSTApiTranslateOutputSchema = typeof translateAgent extends { outputSchema?: infer O } ? O : never;
 ...
 */
export type GETApiTranslateHistoryOutput = InferOutput<typeof TranslateHistoryStateSchema_0>;
 ...
 */
export type GETApiTranslateHistoryOutputSchema = typeof TranslateHistoryStateSchema_0;
 ...
 */
export type DELETEApiTranslateHistoryOutput = InferOutput<typeof TranslateHistoryStateSchema_0>;
 ...
 */
export type DELETEApiTranslateHistoryOutputSchema = typeof TranslateHistoryStateSchema_0;
...
declare module '@agentuity/frontend' {
	...
	'POST /api/translate': {
				...
				stream: typeof translateAgent extends { stream?: infer S } ? S : false;
				params: never;
			};
