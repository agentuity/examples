...
import type codeRunner from '../agent/code-runner/index.js';
...
/**
 * Input type for route: POST /api/run
 */
export type POSTApiRunInput = InferInput<typeof codeRunner['inputSchema']>;

/**
 * Output type for route: POST /api/run
 */
export type POSTApiRunOutput = InferOutput<typeof codeRunner['outputSchema']>;

/**
 * Input schema type for route: POST /api/run
 */
export type POSTApiRunInputSchema = typeof codeRunner extends { inputSchema?: infer I } ? I : never;

/**
 * Output schema type for route: POST /api/run
 */
export type POSTApiRunOutputSchema = typeof codeRunner extends { outputSchema?: infer O } ? O : never;
...
declare module '@agentuity/frontend' {
	...
	'POST /api/run': {
				inputSchema: POSTApiRunInputSchema;
				outputSchema: POSTApiRunOutputSchema;
				stream: typeof codeRunner extends { stream?: infer S } ? S : false;
				params: never;
			};
	}
	...
	export interface RPCRouteRegistry {
		run: {
			 ...
			 * Route: POST /api/run
			 */
			post: { input: POSTApiRunInput; output: POSTApiRunOutput; type: 'api'; params: never; paramsTuple: [] };
		};
	}
}
