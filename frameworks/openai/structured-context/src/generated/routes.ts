...
import type structuredContext from '../agent/structured-context/index.js';
 ...
 */
export type POSTApiChatInput = InferInput<typeof structuredContext['inputSchema']>;

/**
 * Output type for route: POST /api/chat
 */
export type POSTApiChatOutput = InferOutput<typeof structuredContext['outputSchema']>;

/**
 * Input schema type for route: POST /api/chat
 */
export type POSTApiChatInputSchema = typeof structuredContext extends { inputSchema?: infer I } ? I : never;

/**
 * Output schema type for route: POST /api/chat
 */
export type POSTApiChatOutputSchema = typeof structuredContext extends { outputSchema?: infer O } ? O : never;
...
declare module '@agentuity/frontend' {
	...
	'POST /api/chat': {
				...
				stream: typeof structuredContext extends { stream?: infer S } ? S : false;
				params: never;
			};
	}
