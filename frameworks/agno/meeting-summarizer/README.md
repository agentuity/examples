...
# 🤖 Agno Meeting Summarizer Agent

Welcome to the Agno Meeting Summarizer Agent! This agent uses OpenAI tools to process meeting recordings, transcribe audio, summarize content, and extract key insights including action items and decisions.
...
│   └── MeetingSummarizer/  # Meeting summarizer agent
